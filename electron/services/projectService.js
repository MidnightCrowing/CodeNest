...
export async function analyzeProject(event, folderPath) {
    return await new Promise((resolve) => {
        try {
            const workerUrl = new URL('../workers/linguistAnalyze.worker.js', import.meta.url);
            const worker = new Worker(workerUrl, { type: 'module', workerData: { folderPath } });
...
// 读取项目许可证的前若干行
export async function readLicense(folderPath, maxLines = 20) {
    try {
...
// 使用IDE打开项目
export async function openInIDE(idePath, projectPath) {
