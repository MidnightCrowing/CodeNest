...
import type { JeButtonProps } from './types.ts'
...
.je-button {
  ...
  &--secondary-alt:not(:disabled) {
    ...
    @apply light:outline-$gray-9 light:hover:outline-$gray-8 light:active:outline-$gray-7 light:focus:outline-$blue-4;
